...
class ExpanderTest:
    def runSuite(self, is_debug):
        ...
        self.exact(is_debug)
        self.exactSuited(is_debug)
        self.allCombos(is_debug)
        self.allGreaterCombos(is_debug)
        self.allOffsuitCombos(is_debug)
        self.allSuitedCombos(is_debug)
        self.allGreaterOffsuitCombos(is_debug)
        self.allGreaterSuitedCombos(is_debug)
        self.allGreaterSpecificSuitedCombos(is_debug)
        self.allCombosBounded(is_debug)
        self.allOffsuitCombosBounded(is_debug)
        self.allSuitedCombosBounded(is_debug)
        self.allSpecificSuitedCombosBounded(is_debug)
    ...
    def exact(self, is_debug):
        hand = 'JdTc'
        expected = [hand]
        actual = E.expand(hand, is_debug)
        msg = self.getMessage(hand, K.EXACT)
        self.test(expected, actual, msg)

    def exactSuited(self, is_debug):
        hand = 'JThh'
        normalized = 'JhTh'
        expected = [normalized]
        actual = E.expand(hand, is_debug)
    ...
    def allGreaterCombos(self, is_debug):
        hand = '22+'
    ...
    def allOffsuitCombos(self, is_debug):
        hand = 'QTo'
    ...
    def allSuitedCombos(self, is_debug):
        hand = 'QTs'
    ...
    def allGreaterOffsuitCombos(self, is_debug):
        hand = '76o+'
    ...
    def allGreaterSuitedCombos(self, is_debug):
        hand = '76s+'
    ...
    def allGreaterSpecificSuitedCombos(self, is_debug):
        hand = 'JThh+'
    ...
    def allCombosBounded(self, is_debug):
        hand = '54-T9'
    ...
    def allOffsuitCombosBounded(self, is_debug):
        hand = '54-T9o'
    ...
    def allSuitedCombosBounded(self, is_debug):
        hand = '54-T9s'
    ...
    def allSpecificSuitedCombosBounded(self, is_debug):
        hand = '54-T9cc'
